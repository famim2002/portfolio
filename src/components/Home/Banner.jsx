      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 sm:gap-5 h-[calc(100dvh-90px)]">
        <div className="flex flex-col">
          ...
          <div className="mt-5 block ">
            <h3 className="nav-li-css mt-auto text-[35px] w-fit font-headerFont text-amber-50 bg-[#00000021] px-2 py-1 rounded">
              creative
            </h3>
          </div>

          <div className="block lg:hidden bg-[#00000021]">
            <LiveDate />
          </div>

          <div className="origin-top-left mt-auto">
            <h1
              className="text-[calc(10dvh+5px)] sm:text-[calc(5dvh+50px)] md:text-[calc(5dvh+70px)] lg:text-[calc(5dvh+110px)] xl:text-[calc(5dvh+130px)] 2xl:text-[calc(5dvh+180px)]  pt-5 sm:pt-10 md:pt-10 leading-20 sm:leading-35 sm:text-center md:leading-38  lg:leading-42 xl:leading-52 lg:text-left bg-[#00000021]"
              style={{
                fontFamily: "Spacema",
                color: "#f7f6f5",
                letterSpacing: "0.1px",
        ...
        <div>
          ...
          <div className="hidden lg:block bg-[#00000021]">
            <LiveDate />
          </div>

          <div className="pt-1 md:pt-5 lg:pt-20 flex">
            <h2 className="text-white mx-auto text-center lg:ml-auto text-[calc(2dvh+2px)] sm:text-[calc(2dvh+5px)] lg:text-[calc(2dvh+7px)] font-headerFont  max-w-2xl bg-[#00000021]">
