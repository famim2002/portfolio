...
const Card = ({ tag, icon }) => {
  return (
    <div className="relative w-full h-[330px] border-2 md:border-none border-white  md:h-full mx-auto md:mt-24 rounded-2xl overflow-hidden shadow-[0_8px_28px_-9px_rgba(0,0,0,0.45)] bg-transparent cursor-pointer transition-all group border-b-4  border-b-transparent hover:border-b-white active:bg-white ">
      ...
      {/* Content */}
      <div className="absolute top-[5.6rem] left-0 right-0 text-[25px] text-center text-white font-headerFont ">
