...
const Card = ({ tag, icon }) => {
  return (
    <div className="relative w-[240px] h-[330px] mx-auto mt-24 rounded-2xl overflow-hidden shadow-[0_8px_28px_-9px_rgba(0,0,0,0.45)] bg-transparent cursor-pointer transition-all group border-b-4  border-b-transparent hover:border-b-white active:bg-white ">
